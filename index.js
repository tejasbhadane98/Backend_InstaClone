...
mongoose.connect(process.env.DATABASE_URL || "mongodb+srv://root:10xacademy@cluster0.hpnp08y.mongodb.net/?retryWrites=true&w=majority/test").then(() => {
...
app.get("/", (req, res) => {
    res.send("InstaClone Backend By Tejas Bhadane")
})
